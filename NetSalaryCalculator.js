...
const input = userInput("Enter your gross salary: ");

let netSalaryCalculator = function(grossSalary){
    const incomeTax = grossSalary * 0.2;
    let netSalary;
    let ssc;
    let stampDuty;
    if(grossSalary <= 0 || isNaN(grossSalary)){
        netSalary = "Enter a valid amount!"
    }
    else{
     ...
     switch(true)
     {
        ...
        stampDuty = 1500;
        break;
        case(grossSalary > 100000 && grossSalary <=200000):
        stampDuty = 3000;
        break;
        case(grossSalary > 200000 && grossSalary <=500000):
        stampDuty = 5500;
        break;
        case(grossSalary > 500000 && grossSalary <=1000000):
        stampDuty = 8500;
        break;
       ...
       netSalary = grossSalary - incomeTax -ssc - stampDuty;
 }
 return netSalary
}

console.log(netSalaryCalculator(input))